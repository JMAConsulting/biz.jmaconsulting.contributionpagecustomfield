 ...
 */
function _contributionpagecustomfield_civix_civicrm_themes(&$themes) {
  $files = _contributionpagecustomfield_civix_glob(__DIR__ . '/*.theme.php');
  foreach ($files as $file) {
 ...
 * missing them.
 */
function _contributionpagecustomfield_civix_fixNavigationMenu(&$nodes) {
  $maxNavID = 1;
  ...
  _contributionpagecustomfield_civix_fixNavigationMenuItems($nodes, $maxNavID, NULL);
}

function _contributionpagecustomfield_civix_fixNavigationMenuItems(&$nodes, &$maxNavID, $parentID) {
  ...
  foreach ($origKeys as $origKey) {
    ...
    if (isset($nodes[$origKey]['child']) && is_array($nodes[$origKey]['child'])) {
      _contributionpagecustomfield_civix_fixNavigationMenuItems($nodes[$origKey]['child'], $maxNavID, $nodes[$origKey]['attributes']['navID']);
    }
  }
}
 ...
 */
function _contributionpagecustomfield_civix_civicrm_entityTypes(&$entityTypes) {
